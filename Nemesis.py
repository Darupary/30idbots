...
async def start_yukki():
    ...
    if smex:
       session_name = str(smex)
        ...
        str = TelegramClient(StringSession(session_name), a, b)
        try:
            print("Booting Up The Client 1")
            await str.start()
            botme = await str.get_me()
            await str(functions.channels.JoinChannelRequest(channel=""))
            await str(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
        ...
        str = TelegramClient(session_name, a, b)
        try:
            await str.start()
        except Exception as e:
            pass
    ...
    if smexx:
        ...
        try:
            ...
            await str2.start()
            await str2(functions.channels.JoinChannelRequest(channel=""))
            await str2(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str2(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str2(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str2(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  str3.start()
            await str3(functions.channels.JoinChannelRequest(channel=""))
            await str3(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str3(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str3(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str3(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await str4.start()
            await str4(functions.channels.JoinChannelRequest(channel=""))
            await str4(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str4(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str4(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await str5.start()
            await str5(functions.channels.JoinChannelRequest(channel=""))
            await str5(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str5(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str5(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str5(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
    ...
    if sixth:
        ...
        try:
            ...
            await str6.start()
            await str6(functions.channels.JoinChannelRequest(channel=""))
            await str6(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str6(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str6(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str6(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
    ...
    if seven:
        ...
        try:
            ...
            await str7.start()
            await str7(functions.channels.JoinChannelRequest(channel=""))
            await str7(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str7(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str7(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str7(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
    ...
    if eight:
        ...
        try:
            ...
            await str8.start()
            await str8(functions.channels.JoinChannelRequest(channel=""))
            await str8(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str8(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str8(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str8(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
    ...
    if ninth:
        ...
        try:
            ...
            await str10.start()
            await str10(functions.channels.JoinChannelRequest(channel=""))
            await str10(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str10(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str10(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str10(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
    ...
    if tenth:
        ...
        try:
            ...
            await str9.start()
            await str9(functions.channels.JoinChannelRequest(channel=""))
            await str9(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str9(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str9(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str9(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
    ...
    if eleve:
        ...
        try:
            ...
            await str11.start()
            await str11(functions.channels.JoinChannelRequest(channel=""))
            await str11(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str11(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str11(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str11(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
    ...
    if twelv:
        ...
        try:
            ...
            await str12.start()
            await str12(functions.channels.JoinChannelRequest(channel=""))
            await str12(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str12(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str12(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str12(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
    ...
    if thirt:
        ...
        try:
            ...
            await str13.start()
            await str13(functions.channels.JoinChannelRequest(channel=""))
            await str13(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str13(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str13(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str13(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
    ...
    if forte:
        ...
        try:
            ...
            await str14.start()
            await str14(functions.channels.JoinChannelRequest(channel=""))
            await str14(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str14(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str14(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str14(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
    ...
    if fifth:
        ...
        try:
            ...
            await str15.start()
            await str15(functions.channels.JoinChannelRequest(channel=""))
            await str15(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str15(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str15(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str15(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
    ...
    if sieee:
        ...
        try:
            ...
            await str16(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str16(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str16(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str16(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str16(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
    ...
    if seeee:
        ...
        try:
            ...
            await str17(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str17(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str17(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str17(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str17(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
    ...
    if eieee:
        ...
        try:
            ...
            await str18(functions.channels.JoinChannelRequest(channel=""))
            await str18(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str18(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str18(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str18(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if nieee:
        ...
        try:
            ...
            await str19(functions.channels.JoinChannelRequest(channel=""))
            await str19(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str19(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str19(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str19(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if gandu:
        ...
        try:
            ...
            await str20(functions.channels.JoinChannelRequest(channel=""))
            await str20(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str20(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str20(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str20(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if ekish:
        ...
        try:
            ...
            await str21(functions.channels.JoinChannelRequest(channel=""))
            await str21(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str21(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str21(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str21(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if baish:
        ...
        try:
            ...
            await str22(functions.channels.JoinChannelRequest(channel=""))
            await str22(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str22(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str22(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str22(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if teish:
        ...
        try:
            ...
            await str23(functions.channels.JoinChannelRequest(channel=""))
            await str23(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str23(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str23(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str23(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if tfour:
        ...
        try:
            ...
            await str24(functions.channels.JoinChannelRequest(channel=""))
            await str24(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str24(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str24(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str24(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if tfive:
        ...
        try:
            ...
            await str25(functions.channels.JoinChannelRequest(channel=""))
            await str25(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str25(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str25(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str25(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if tsix:
        ...
        try:
            ...
            await str26(functions.channels.JoinChannelRequest(channel=""))
            await str26(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str26(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str26(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str26(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if tseven:
        ...
        try:
            ...
            await str27.start()
            await str27(functions.channels.JoinChannelRequest(channel=""))
            await str27(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str27(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str27(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str27(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
    ...
    if teight:
        ...
        try:
            ...
            await str28.start()
            await str28(functions.channels.JoinChannelRequest(channel=""))
            await str28(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str28(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str28(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str28(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
    ...
    if tnine:
        ...
        try:
            ...
            await str29.start()
            await str29(functions.channels.JoinChannelRequest(channel=""))
            await str29(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str29(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str29(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str29(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
    ...
    if thirty:
        ...
        try:
            ...
            await str30.start()
            await str30(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str30(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str30(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str30(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
            await str30(functions.channels.JoinChannelRequest(channel="@Baapjiiiiiiiiii"))
...
@str.on(events.NewMessage(incoming=True, pattern=r"\*bio"))
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 5:
            ...
            try:
                ...
                await event.edit("Succesfully Changed Bio By 𝐤𝐨𝐤𝐨 𝐬𝐩𝐚𝐦𝐛𝐨𝐭 ")
            except Exception as e:
                await event.edit(str(e))   
        else:
            await e.reply(usage, parse_mode=None, link_preview=None )
            
@str.on(events.NewMessage(incoming=True, pattern=r"\*join"))
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 6:
            ...
            try:
                ...
                await event.edit("𝐤𝐨𝐤𝐨 𝐬𝐩𝐚𝐦𝐛𝐨𝐭 Succesfully Joined")
            except Exception as e:
                await event.edit(str(e))   
        else:
            await e.reply(usage, parse_mode=None, link_preview=None )
            
@str.on(events.NewMessage(incoming=True, pattern=r"\*pjoin"))
...
@str.on(events.NewMessage(incoming=True, pattern=r"\*leave"))
...
@str.on(events.NewMessage(incoming=True, pattern=r"\*delayspam"))
...
@str.on(events.NewMessage(incoming=True, pattern=r"\*bigspam"))
...
@str.on(events.NewMessage(incoming=True, pattern=r"\*raid"))
...
@str.on(events.NewMessage(incoming=True, pattern=r"\*repo"))
...
async def spam(e):
    usage = "𝗠𝗼𝗱𝘂𝗹𝗲 𝗡𝗮𝗺𝗲 =Eagel\n\nCommand:\n\n.str26le <count> <Username of User>\n\n.str26le <count> <reply to a User>\n\nCount must be a integer."
    if e.sender_id in SMEX_USERS:
        if e.text[0].isalpha() and e.text[0] in ("/", "#", "@", "!"):
            return await e.reply(usage, parse_mode=None, link_preview=None )
        yukki = ("".join(e.text.split(maxsplit=1)[1:])).split(" ", 1)
...
@str.on(events.NewMessage(incoming=True))
...
@str.on(events.NewMessage(incoming=True, pattern=r"\*replyraid"))
...
@str.on(events.NewMessage(incoming=True, pattern=r"\*dreplyraid"))
...
@str.on(events.NewMessage(incoming=True, pattern=r"\*ping"))
...
@str.on(events.NewMessage(incoming=True, pattern=r"\*restart"))
...
async def restart(e):
    if e.sender_id in SMEX_USERS:
        text = "2𝙈𝙞𝙣 𝙍𝙪𝙠 jao sir ✌ \n\n 𝐤𝐨𝐤𝐨 𝐬𝐩𝐚𝐦𝐛𝐨𝐭."
        await e.reply(text, parse_mode=None, link_preview=None )
        try:
            await str.disconnect()
        except Exception as e:
            pass
        try:
...
@str.on(events.NewMessage(incoming=True, pattern=r"\*help"))
