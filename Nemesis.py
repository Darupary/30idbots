...
async def start_yukki():
    ...
    if smex:
        ...
        try:
            ...
            await str(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
    ...
    if smexx:
        ...
        try:
            ...
            await str2(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str2(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str2(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str2(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
    ...
    if smexxx:
        ...
        try:
            ...
            await str3(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str3(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str3(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str3(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await str4(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str4(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str4(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await str5(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str5(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str5(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str5(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
    ...
    if sixth:
        ...
        try:
            ...
            await str6(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str6(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str6(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str6(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
    ...
    if seven:
        ...
        try:
            ...
            await str7(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str7(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str7(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str7(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
    ...
    if eight:
        ...
        try:
            ...
            await str8(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str8(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str8(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str8(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
    ...
    if ninth:
        ...
        try:
            ...
            await str10(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str10(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str10(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str10(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
    ...
    if tenth:
        ...
        try:
            ...
            await str9(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str9(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str9(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str9(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
    ...
    if eleve:
        ...
        try:
            ...
            await str11(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str11(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str11(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str11(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
    ...
    if twelv:
        ...
        try:
            ...
            await str12(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str12(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str12(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str12(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
    ...
    if thirt:
        ...
        try:
            ...
            await str13(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str13(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str13(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str13(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
    ...
    if forte:
        ...
        try:
            ...
            await str14(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str14(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str14(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str14(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
    ...
    if fifth:
        ...
        try:
            ...
            await str15(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str15(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str15(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str15(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
    ...
    if sieee:
        ...
        try:
            ...
            await str16(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str16(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str16(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str16(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str16(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
    ...
    if seeee:
        ...
        try:
            ...
            await str17(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str17(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str17(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str17(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str17(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
    ...
    if eieee:
        ...
        try:
            ...
            await str18(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str18(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str18(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str18(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if nieee:
        ...
        try:
            ...
            await str19(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str19(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str19(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str19(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if gandu:
        ...
        try:
            ...
            await str20(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str20(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str20(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str20(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if ekish:
        ...
        try:
            ...
            await str21(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str21(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str21(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str21(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if baish:
        ...
        try:
            ...
            await str22(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str22(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str22(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str22(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if teish:
        ...
        try:
            ...
            await str23(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str23(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str23(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str23(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if tfour:
        ...
        try:
            ...
            await str24(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str24(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str24(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str24(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if tfive:
        ...
        try:
            ...
            await str25(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str25(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str25(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str25(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if tsix:
        ...
        try:
            ...
            await str26(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str26(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str26(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str26(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if tseven:
        ...
        try:
            ...
            await str27(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str27(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str27(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str27(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
    ...
    if teight:
        ...
        try:
            ...
            await str28(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str28(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str28(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str28(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
    ...
    if tnine:
        ...
        try:
            ...
            await str29(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str29(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str29(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str29(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
    ...
    if thirty:
        ...
        try:
            ...
            await str30.start()
            await str30(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str30(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str30(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str30(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
            await str30(functions.channels.JoinChannelRequest(channel="@TeamXY7"))
